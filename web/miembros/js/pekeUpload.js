...
(function($) {
  ...
  $.fn.pekeUpload = function(options){
    ...
    this.each(function() {
      ...
      var html = '<a href="javascript:void(0)" class="btn btn-small btn-primary btn-upload"> <span class="icon-upload icon-white"></span> '+options.btnText+'</a><div class="pekecontainer"></div>';
      }
