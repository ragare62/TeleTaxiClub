...
function loadCarro() {
    $.ajax({
        type: "GET",
        url: "http://localhost:3000/api/carro/" + vm.idMiembro(),
        dataType: "json",
        ...
        buttons: {
            ...
            borrar: {
                ...
                callback: function() {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "http://localhost:3000/api/canjes/" + idCanje,
                        dataType: "json",
                        contentType: "application/json",
            ...
            buttons: {
                ...
                borrar: {
                    ...
                    callback: function() {
                        $.ajax({
                            type: "DELETE",
                            url: "http://localhost:3000/api/borra_carro/" + vm.idMiembro(),
                            dataType: "json",
                            contentType: "application/json",
                            success: function(data, status) {
                                window.open("tucarro.html?idMiembro=" + vm.idMiembro(), '_self');
            ...
            buttons: {
                ...
                confirmar: {
                    ...
                    callback: function() {
                        $.ajax({
                            type: "POST",
                            url: "http://localhost:3000/api/confirma_carro/" + vm.idMiembro(),
                            dataType: "json",
                            contentType: "application/json",
                            success: function(data, status) {
